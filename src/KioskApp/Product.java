...
public class Product extends Menu {
    ...
    /*KioskApp.Product(int pid, String productcategory, String pname, double p, String pdesc,List<String> pOpt) {
        super(pname,pdesc);
        this.productcategory = productcategory;
        this.pid = pid;
        this.price = p;
    ...
    public void delOption(String opt) {
