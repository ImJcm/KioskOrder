...
public class MainMenuScreen implements Screen {
    HiddenMenuScreen hiddenMenuScreen = new HiddenMenuScreen();
    MenuDetailScreen menuDetailScreen = new MenuDetailScreen();
    MenuOrderScreen menuOrderScreen = new MenuOrderScreen();
