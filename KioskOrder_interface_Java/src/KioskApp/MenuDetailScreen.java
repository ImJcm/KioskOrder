...
public class MenuDetailScreen implements Screen {
    ...
    @Override
    public void ScreenShow(int productcategory) {
        //메뉴 상품 리스트 생성
